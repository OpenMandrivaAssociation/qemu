...
%endif
    ...
    %make V=1 $buildldflags LIBS='-lrt -lm -lglib-2.0 -lcap-ng -lz -lcurl -luuid -lsasl2 -lusbredirparser -lspice-server -lbrlapi -lpng15 -ljpeg -lgnutls -lasound -lpulse -lSDL -lX11 -lbluetooth -lseccomp -lutil'
}
