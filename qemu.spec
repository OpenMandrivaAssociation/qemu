...
install -m755 qemu-static/qemu-wrapper -D %{buildroot}%{_bindir}/qemu-wrapper
...
echo ':arm:M::\x7fELF\x01\x01\x01\x00\x00\x00\x00\x00\x00\x00\x00\x00\x02\x00\x28\x00:\xff\xff\xff\xff\xff\xff\xff\x00\xff\xff\xff\xff\xff\xff\xff\xff\xfe\xff\xff\xff:/usr/bin/qemu-wrapper:' > %{buildroot}%{_binfmtdir}/arm.conf
